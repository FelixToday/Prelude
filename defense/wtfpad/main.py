...
def main():
    ...
    cw_filenames = [filename for filename in filenames if "-" in os.path.basename(filename)]
    ow_filenames = [filename for filename in filenames if "-" not in os.path.basename(filename)]
    ...
    for filename in cw_filenames + ow_filenames:
        ...
        try:
            ...
            logger.warning("Skipping non-trace file: %s" % filename)
            continue
